...
public enum ImageFormatType {
	...
	/**
	 * Gets the unique integer ID that this Titanium module uses to represent this
	 * image format in JavaScript.
	 * 
	...
	/**
	 * Fetch an image format matching the given integer ID used by this Titanium
	 * module in JavaScript.
	 * 
	 * @param value The unique integer ID used by the module in JavaScript.
	 * @return Returns the matching image format type. Returns null if given an
	 *         invalid ID.
	 */
	...
	/**
	 * Fetches an image format matching the given Android "CompressionFormat" enum
	 * ID.
	 * 
	 ...
	 * 
	 * @param fileExtension Image file extension such as "png", "jpg", or "jpeg".
	 *                      Not case sensitive. Can be null.
	 * @return
	 ...
	 * 
	 * @param mimeType The mime type string such as "image/png", "image/jpeg", etc.
	 *                 Can be null.
	 * @return
	...
	/**
	 * Fetches an image format type from the given dictionary provided to this
	 * Titanium module's
	 * JavaScript methods. Will fetch the "format" entry from the dictionary and its
	 * value must
	 ...
	 * @return
	 *         Returns an image format type specified by the given "options"
	 *         argument's "format" entry.
	 *         <p/>
	 *         Returns ImageFormatType.JPEG if given a null argument or if the
	 *         "format" entry is missing.
	 */
	 ...
	 *         argument's "format" entry.
	 *         <p/>
	 *         Returns the "defaultType" argument if given argument is null or doesn
	 *         not contain a "format" entry.
	 */
